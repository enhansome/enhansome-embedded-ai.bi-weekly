...
# Awesome Embedded-AI-Report with stars
...
* Qualcomm Adreno GPU Performance as below:\
  ![adreno\_gpu\_performance](./device_benchmark/qualcomm_adreno_gpu_benchmark.png)

* [手机处理器天梯图\_最新CPU天梯图\_手机CPU性能天梯图 | ZOL中关村在线](http://mobile.zol.com.cn/soc/)
...
* \[1704.06904] [Residual Attention Network for Image Classification](https://arxiv.org/pdf/1704.06904.pdf) [\[code\]](https://github.com/buptwangfei/residual-attention-network) ⭐ 558 | 🐛 18 | 📅 2017-07-21
...
* \[CVPR2017] [Local Binary Convolutional Neural Networks](http://xujuefei.com/lbcnn.html) [\[code\]](https://github.com/juefeix/lbcnn.torch) ⭐ 105 | 🐛 6 | 🌐 Lua | 📅 2018-11-01
...
* [Learning to Prune: Exploring the Frontier of Fast and Accurate Parsing](http://www.cs.jhu.edu/~jason/papers/vieira+eisner.tacl17.pdf) [\[code\]](https://github.com/timvieira/learning-to-prune) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2024-09-24
...
* [liuzhuang13/DenseNet: Densely Connected Convolutional Networks, In CVPR 2017 (Best Paper Award)](https://github.com/liuzhuang13/DenseNet) ⭐ 4,869 | 🐛 30 | 🌐 Lua | 📅 2024-01-09
...
* [OpenMined/Syft: Homomorphically Encrypted Deep Learning Library](https://github.com/OpenMined/syft) ⭐ 22 | 🐛 41 | 🌐 Python | 📅 2026-08-26
...
* [bearpaw/PyraNet: Code for "Learning Feature Pyramids for Human Pose Estimation" (ICCV 2017)](https://github.com/bearpaw/PyraNet) ⭐ 221 | 🐛 11 | 🌐 Lua | 📅 2021-12-20
* [bearpaw/PyraNet: Code for "Learning Feature Pyramids for Human Pose Estimation" (ICCV 2017)](https://github.com/bearpaw/PyraNet) ⭐ 221 | 🐛 11 | 🌐 Lua | 📅 2021-12-20
* [LaoDar/cnn\_head\_pose\_estimator: a simple and fast mxnet version CNN based head pose estimator](https://github.com/LaoDar/cnn_head_pose_estimator) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2018-01-15
* [aquaviter/iot-demo-mxnet-greengrass](https://github.com/aquaviter/iot-demo-mxnet-greengrass) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2017-07-01
...
* [bjarnel/scenekit-tictactoe](https://github.com/bjarnel/scenekit-tictactoe) ⚠️ Archived

## Android

* [TensorFlow Android Camera Demo](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/android) ⭐ 197,719 | 🐛 2,942 | 🌐 C++ | 📅 2026-08-27
...
* [SaschaWillems/Vulkan: Examples and demos for the new Vulkan API](https://github.com/SaschaWillems/Vulkan) ⭐ 12,129 | 🐛 19 | 🌐 GLSL | 📅 2026-08-18
* [ARM-software/vulkan-sdk: ARM Vulkan SDK](https://github.com/ARM-software/vulkan-sdk) ⭐ 243 | 🐛 6 | 🌐 C | 📅 2023-02-25
...
* [Tencent/ncnn: ncnn is a high-performance neural network inference framework optimized for the mobile platform](https://github.com/Tencent/ncnn) ⭐ 23,755 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-25
* [Deep Learning in a Single File for Smart Devices — mxnet](https://github.com/dmlc/mxnet/tree/master/amalgamation) ⚠️ Archived
* [ARM-software/ComputeLibrary: The ARM Computer Vision and Machine Learning library is a set of functions optimised for both ARM CPUs and GPUs using SIMD technologies](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,183 | 🐛 4 | 🌐 C++ | 📅 2026-08-12 [Intro](https://developer.arm.com/technologies/compute-library)
...
* [baidu-research/DeepBench: Benchmarking Deep Learning operations on different hardware](https://github.com/baidu-research/DeepBench) ⭐ 1,106 | 🐛 23 | 🌐 C++ | 📅 2021-04-25
...
Model convertor. More convertors please refer [deep-learning-model-convertor](https://github.com/ysh329/deep-learning-model-convertor) ⭐ 3,236 | 🐛 2 | 📅 2023-06-26
...
* [MTG/essentia: C++ library for audio and music analysis, description and synthesis, including Python bindings](https://github.com/MTG/essentia) ⭐ 3,706 | 🐛 425 | 🌐 C++ | 📅 2026-07-22
...
* [pili-engineering/PLPlayerKit: PLPlayerKit 是 Pili 直播 SDK 的 iOS 播放器。支持所有直播常用的格式，如：RTMP、HLS、FLV。拥有优秀的功能和特性，如：首屏秒开、追帧优化、丰富的数据和状态回调、硬解软解支持。而且可以根据自己的业务进行高度定制化开发。](https://github.com/pili-engineering/PLPlayerKit) ⭐ 1,982 | 🐛 84 | 📅 2025-09-05
* [pili-engineering/PLDroidShortVideo: PLDroidShortVideo 是七牛推出的一款适用于 Android 平台的短视频 SDK，提供了包括美颜、滤镜、水印、断点录制、分段回删、视频编辑、混音特效、本地/云端存储在内的多种功能，支持高度定制以及二次开发。](https://github.com/pili-engineering/PLDroidShortVideo) ⭐ 1,715 | 🐛 122 | 🌐 Java | 📅 2024-05-17
...
* [pili-engineering/PLShortVideoKit: PLShortVideoKit 是七牛推出的一款适用于 iOS 平台的短视频 SDK，提供了包括美颜、滤镜、水印、断点录制、分段回删、视频编辑、混音特效、本地/云端存储在内的多种功能，支持高度定制以及二次开发。](https://github.com/pili-engineering/PLShortVideoKit) ⭐ 453 | 🐛 17 | 🌐 Objective-C | 📅 2024-04-30
