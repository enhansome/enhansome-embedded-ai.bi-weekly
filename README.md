...
* [OpenMined/Syft: Homomorphically Encrypted Deep Learning Library](https://github.com/OpenMined/syft) ⭐ 22 | 🐛 41 | 🌐 Python | 📅 2026-09-08
...
* [TensorFlow Android Camera Demo](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/android) ⭐ 199,333 | 🐛 3,127 | 🌐 C++ | 📅 2026-09-08
...
* [SaschaWillems/Vulkan: Examples and demos for the new Vulkan API](https://github.com/SaschaWillems/Vulkan) ⭐ 12,143 | 🐛 17 | 🌐 GLSL | 📅 2026-08-28
...
* [Tencent/ncnn: ncnn is a high-performance neural network inference framework optimized for the mobile platform](https://github.com/Tencent/ncnn) ⭐ 23,792 | 🐛 1,250 | 🌐 C++ | 📅 2026-09-08
* [Deep Learning in a Single File for Smart Devices — mxnet](https://github.com/dmlc/mxnet/tree/master/amalgamation) ⚠️ Archived
* [ARM-software/ComputeLibrary: The ARM Computer Vision and Machine Learning library is a set of functions optimised for both ARM CPUs and GPUs using SIMD technologies](https://github.com/ARM-software/ComputeLibrary) ⭐ 3,189 | 🐛 4 | 🌐 C++ | 📅 2026-09-08 [Intro](https://developer.arm.com/technologies/compute-library)
* [Microsoft Embedded Learning Library](https://github.com/Microsoft/ELL) ⚠️ Archived
* [mil-tokyo/webdnn: Fastest DNN Execution Framework on Web Browser](https://github.com/mil-tokyo/webdnn) ⭐ 1,998 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-28
...
* [MTG/essentia: C++ library for audio and music analysis, description and synthesis, including Python bindings](https://github.com/MTG/essentia) ⭐ 3,712 | 🐛 436 | 🌐 C++ | 📅 2026-08-27
